...
ui.grid = class MamboGrid extends HTMLElement {
    constructor(initOptions) {
        ...
        function installTile(tileData, tileIndex) {
            ...
            let tileTag = dom.createTag(m_config.tag.tileItem, { class: m_config.css.tileItem, attr: { m_tileIndexAttrName: tileIndex } });
        ...
        async function installRows() {
            ...
            function processRow(rowData, rowIndex) {
                ...
                let rowTag = dom.createTag(m_config.tag.row, { class: m_config.css.row, attr: { m_rowIndexAttrName: rowIndex } });
