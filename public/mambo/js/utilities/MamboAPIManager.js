 ...
 *******************************************/
function MamboAPIManager(options) {
    'use strict';
    ...
    function execRequest(method, url, config) {
        const xhrConfig = g_mamboUtils.extend(true, m_config, config);
    ...
    function configure() {
        ...
        if (options) {
            m_config = g_mamboUtils.extend(true, m_config, options);
        }
    }
